...
class Footer extends Component {
    ...
    navigateURL = (platform) => {
        if (platform == 'github') {
            ...
            return window.open('https://www.linkedin.com/in/nihanth-reddy-685b84187/')
            ...
            return window.open('mailto:kethireddy.nihanth@gmail.com?subject=SendMail&body=Description')
        }
    }
